...
public class add_to_cart extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e=(EditText) findViewById(R.id.editTextTextPersonName13);
    ...
    public void onClick(View view) {
        ...
        String url = "http://" + hu + ":5000/add_cartadd";
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("pid",sh.getString("prdtid",""));
                params.put("lid",sh.getString("lid",""));
                params.put("price",sh.getString("price",""));
                params.put("qty",e.getText().toString());
                params.put("cartid",sh.getString("cartid",""));
